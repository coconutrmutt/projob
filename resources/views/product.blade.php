    ...
    <div class="content_bottom">
      <div class="col-lg-8 col-md-8">
        <div class="content_bottom_left">
          <div class="single_page_area">
            <h2 class="post_titile"><!-- ใส่สินค้า --></h2>
          </div>
        </div>
          ...
          <!-- ตารางแสดงรายชื่อผู้ประมุล -->
          <table class="table table-sm">
            <thead>
              <tr>
                <th>ชื่อผู้ใช้/ประมูลอัตโนมัติ</th>
        ...
        <div class="similar_post">
          <!-- เเถวแสดงรายละเอียดสินค้า -->
          <div class="single_bottom_rightbar">
            <ul role="tablist" class="nav nav-tabs custom-tabs">
              <li class="active" role="presentation"><a data-toggle="tab" role="tab" aria-controls="home" href="#mostPopular">รายละเอียดสินค้า</a></li>
      ...
      <div class="col-lg-4 col-md-4">
        <div class="content_bottom_right">
          ...
          <div class="catgimg_container"> <a href="{{url('product')}}" class="catg1_img"><img alt="" src="images/1.jpg"></a></div><br>
          <div class="catgimg_container"> <a href="{{url('product')}}" class="catg1_img"><img alt="" src="images/1.jpg"></a></div><br>
          <div class="catgimg_container"> <a href="{{url('product')}}" class="catg1_img"><img alt="" src="images/1.jpg"></a></div><br>
          <div class="catgimg_container"> <a href="{{url('product')}}" class="catg1_img"><img alt="" src="images/1.jpg"></a></div><br>
